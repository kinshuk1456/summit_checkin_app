# app.py — Summit Check-in & Occupancy (roles, move logic, nearby, kiosk, bg)
...
# ---------------------- Optional: Background image on student page ----------------------
...
# Use your RAW GitHub URL (png is fine)
BG_URL = "https://raw.githubusercontent.com/kinshuk1456/summit_checkin_app/main/assets/bg.png"
if mode == "checkin":
...
def sheet_upsert(email: str, row: list):
    ...
    try:
        ...
        # find existing (skip header at index 0)
        row_num = None
